...
export default class BaseTextComponent extends Component {
    ...
    updateValue(text) {
        ...
        return new Promise((resolve, reject) => {
			...
			if(self._mustUpdateValue(maskedText)) {
                ...
                console.log("updateValue start: " + newSelection.start + " end: " + newSelection.end);
    ...
    updateSelection(selectionUpdate, maxLength){
        ...
        if(!self.state.selectionOverride){
            ...
            //console.log("SelectionChange Overridden start: " + selectionUpdate.start + " end: " + selectionUpdate.end);
            self.setState({
                selectionOverride: false
            });
        }
